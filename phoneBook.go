...
var CSVFILE = "/Users/luisvargas/Desktop/Go/phoneBook/csv.data"
...
func main() {
	...
	// if error is not nil, it means that the file does not exists
	if err != nil {
		fmt.Println("Creating CSV FILE:", CSVFILE)
